...
?>  
    ...
    <div class="container-fluid remove-vid-marg">
      ...
      <div class="vid-content" >
        <h1 class="my-content">Welcome to Study-Nerd</h1>
        <small class="my-content">Learn At Your Pace</small><br />
        <?php    
    ...
    ?>  
     ...
     <!-- Start Students Testimonial -->
      <div class="container-fluid mt-5" style="background-color: #6666FF" id="Feedback">
    ...
    <div class="container-fluid p-4" style="background-color:#E9ECEF">
      <div class="container" style="background-color:#E9ECEF">
        <div class="row text-center">
          <div class="col-sm">
            <h5>About Us</h5>
              <p>Study-Nerd provides universal access to the world’s best education, partnering with top universities and organizations to offer courses online.</p>
          </div>
          <div class="col-sm">
            <h5>Category</h5>
          ...
          <div class="col-sm">
            <h5>Contact Us</h5>
            <p>Study-Nerd Pvt Ltd <br> Near Pant Nagar Police St. <br> Ghatkopar, Mumbai <br> Ph. 000000000 </p>
          </div>
        </div>
      </div>
